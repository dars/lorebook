...
Character 頁面 SHALL 包含五個次級 Tab：總覽 / 屬性 / 法術 / 物品 / 傳記。
...
#### Scenario: 基本資訊表格
- **WHEN** 總覽頁顯示
- **THEN** 以 2 欄 × 4 列格狀排列顯示：Species 物種、Type 生物類型、Size 體型、Alignment 陣營、Gender 性別、Age 年齡、Deity 信仰、Background 背景
