      ...
      body: Center(
        child: SizedBox(
          ...
          child: AbilityShield(
            nameCn: '智力',
            nameEn: 'INT',
            modifier: context.knobs.int
                .slider(label: 'Modifier', initialValue: 3, min: -2, max: 6),
            score: context.knobs.int
                .slider(label: 'Score', initialValue: 17, min: 3, max: 20),
            highlighted:
                context.knobs.boolean(label: 'Highlighted', initialValue: true),
          ),
        ),
      ),
    );
